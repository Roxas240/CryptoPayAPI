...
import com.xemplar.libs.cryptorpc.Commands;
import com.xemplar.libs.cryptorpc.CommunicationException;
import com.xemplar.libs.cryptorpc.CryptocoinException;
import com.xemplar.libs.cryptorpc.common.DataFormats;
import com.xemplar.libs.cryptorpc.common.Defaults;
import com.xemplar.libs.cryptorpc.domain.*;
import com.xemplar.libs.cryptorpc.jsonrpc.client.JsonRpcClient;
import com.xemplar.libs.cryptorpc.jsonrpc.client.JsonRpcClientImpl;
import com.xemplar.libs.cryptorpc.util.CollectionUtils;
import com.xemplar.libs.cryptorpc.util.NumberUtils;
import org.apache.http.impl.client.CloseableHttpClient;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class CryptoClientImpl implements CryptoClient {

	private static final Logger LOG = LoggerFactory.getLogger(CryptoClientImpl.class);

	private ClientConfigurator configurator;
	private JsonRpcClient rpcClient;


	public CryptoClientImpl(Properties nodeConfig) throws CryptocoinException, CommunicationException {
		this(null, nodeConfig);
	}

	public CryptoClientImpl(CloseableHttpClient httpProvider, Properties nodeConfig) 
	...
	public CryptoClientImpl(String rpcUser, String rpcPassword) throws CryptocoinException, 
			CommunicationException {
		this(null, null, rpcUser, rpcPassword);
	}

	public CryptoClientImpl(CloseableHttpClient httpProvider, String rpcUser, String rpcPassword) 
			throws CryptocoinException, CommunicationException {
		this(httpProvider, null, null, rpcUser, rpcPassword);
	}

	public CryptoClientImpl(String rpcHost, Integer rpcPort, String rpcUser, String rpcPassword) 
			throws CryptocoinException, CommunicationException {
		this((String)null, rpcHost, rpcPort, rpcUser, rpcPassword);
	}

	public CryptoClientImpl(CloseableHttpClient httpProvider, String rpcHost, Integer rpcPort,
	...
	public CryptoClientImpl(String rpcProtocol, String rpcHost, Integer rpcPort, String rpcUser,
	...
	public CryptoClientImpl(CloseableHttpClient httpProvider, String rpcProtocol, String rpcHost,
